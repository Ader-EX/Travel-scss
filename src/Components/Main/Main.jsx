...
import img3 from "../../Assets/GBReef.jpg";
import img4 from "../../Assets/Cappadocia.jpeg";
import img5 from "../../Assets/Guanajuato.jpg";
import img6 from "../../Assets/CTerre.jpg";
import img7 from "../../Assets/AWat.jpg";
import img8 from "../../Assets/TMahal.jpeg";
...
const Data = [
  ...
  },
  {
    ...
    fees: "$700",
    description:
      "One of the most remarkable Australian natural gifts is the GreatBarrier Reef. The hallmark of this place is lavish andbeauty Always  interesting to be in this place.",
  },

  {
    ...
    fees: "$800",
    description:
      "According to the World Tourism Ranking, 45 Million people visit Turkey each year, and from that about 2 Million come to visit Cappadocia. This place is known for its luxurious stays an adventurous activities.",
  },
  {
    id: 5,
    imgSrc: img5,
